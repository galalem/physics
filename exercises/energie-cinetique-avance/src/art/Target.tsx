// Target — bullseye. Three concentric rings + center dot.
// { x, y } = center. `hit` swaps palette from unlit (muted) to lit (teal).
// To swap in more detailed art later (e.g., a wooden crate or a scoring
// bullseye with paint texture): keep the { x, y, hit } signature.
