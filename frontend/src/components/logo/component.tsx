...
export function Logo({ className }: { className?: string }) {
  return (
    <Link
      to="/"
      dir="ltr"
      className={`d-inline-flex align-items-center text-reset text-decoration-none ${className || ''}`}
      style={{ gap: '2px' }}
    >
      <svg
        className="text-primary"
        viewBox="45 14 90 152"
        width="18"
        height="30"
        fill="none"
        aria-hidden="true"
      ...
      <span style={{ fontSize: '22px', fontWeight: 600, letterSpacing: '-0.045em' }}>ysics</span>
      <span
        aria-hidden="true"
